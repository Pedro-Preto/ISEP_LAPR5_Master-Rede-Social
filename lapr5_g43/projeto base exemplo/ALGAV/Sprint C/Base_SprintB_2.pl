...
ligacao(1,11,10,8,4,5).
ligacao(1,12,2,6,5,6).
ligacao(1,13,-3,-2,1,6).
ligacao(1,14,1,-5,3,4).
ligacao(11,13,5,7,4,6).
ligacao(1,2,2,3,5,7).
ligacao(1,13,5,4,9,5).
ligacao(13,51,8,7,6,5).
ligacao(51,2,9,5,3,4).
