...
@Component({
  selector: 'app-deny-connection-requests-page',
  templateUrl: './deny-connection-requests-page.component.html',
  styleUrls: ['./deny-connection-requests-page.component.css']
})
export class DenyConnectionRequestsPageComponent implements OnInit {
  ...
  public denyConnectionRequest(){
    console.log("aquiiii");
    console.log(this.connectionRequestId);
    console.log();

    this.connectionRequestService.denyConnectionRequest(this.connectionRequestId).subscribe(data => {
      console.log(data);
