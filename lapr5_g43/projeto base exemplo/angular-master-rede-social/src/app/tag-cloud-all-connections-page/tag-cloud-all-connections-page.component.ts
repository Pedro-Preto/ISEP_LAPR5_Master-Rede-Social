...
@Component({
  selector: 'app-tag-cloud-all-connections-page',
  templateUrl: './tag-cloud-all-connections-page.component.html',
  styleUrls: ['./tag-cloud-all-connections-page.component.css']
})
export class TagCloudAllConnectionsPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getTagCloudAllConnections();
  }
  public logout(){
    console.log(this.loggedUserId);
  ...
  public getTagCloudAllConnections(){
    this.connectionService.getTagCloudAllConnections().subscribe(data=>{
      //  this.tags=data;
      console.log(data)
