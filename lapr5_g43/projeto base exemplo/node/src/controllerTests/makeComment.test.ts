...
describe('post controller make comment', () => {

    it('makeComment: returns IPostDTO', async function () {
        let body = {
            "postId":"2",
            "content": "new Post",
        ...
        beforeEach(() => {
            // @ts-ignore
            sinon.stub(postServiceInstance, "makeComment").returns(({
        ...
        it('should create comment', async () => {
            ...
            // @ts-ignore
            await postControllerInstance.makeComment(<Request>req, <Response>res);
