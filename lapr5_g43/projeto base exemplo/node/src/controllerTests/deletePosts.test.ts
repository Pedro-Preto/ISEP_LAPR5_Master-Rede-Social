...
describe('post controller delete', () => {
    ...
    it('deletePosts: returns IPostDTO', async function () {
        let body = {
            "postId": "2",
            "content": "New Post",
        ...
        beforeEach(() => {
            // @ts-ignore
            sinon.stub(postServiceInstance, "deletePosts").returns(({
        ...
        it('should like ', async () => {
            ...
            // @ts-ignore
            await postControllerInstance.deletePosts(<Request>req, <Response>res);
