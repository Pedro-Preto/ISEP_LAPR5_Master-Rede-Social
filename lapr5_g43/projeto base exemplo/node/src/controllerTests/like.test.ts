...
describe('post controller like', () => {

    it('like: returns IPostDTO', async function () {
        let body = {
            "postId": "2",
            "content": "New Post",
        ...
        beforeEach(() => {
            // @ts-ignore
            sinon.stub(postServiceInstance, "like").returns(({
        ...
        it('should like ', async () => {
            ...
            // @ts-ignore
            await postControllerInstance.like(<Request>req, <Response>res);
